...
<div class="adm-wrap">
  ...
  <div class="adm-card">
    ...
    <p class="why">Of the questions a student got wrong, how many did they later get right? This is the only number that tests what Keen claims to do.</p>
    <table class="adm">
      <tr><th>Questions missed on the first try</th><td class="num">${num(retest.missed)}</td><td class="num"></td><td class="bar-cell"></td></tr>
    ...
    <p class="adm-note">Read it this way: if the second row is low, the app is not bringing missed questions back often enough, which is a scheduling problem. If the second row is high and the last row is low, it brings them back and they do not stick, which means the explanations are not teaching.</p>
  </div>
  ...
  <div class="adm-card">
    ...
    <p class="why">Each row is a subset of the one above. The biggest gap between two rows is the thing worth fixing next.</p>
    <table class="adm">
