...
We do not knowingly collect information from anyone under 13. If we learn an
account belongs to a child under 13, we will delete it and its data.
...
the College Board, ACT, Inc., or any other testing organisation, and **we are
not affiliated with, endorsed by, sponsored by, or connected to** any of them.
AP, SAT, PSAT/NMSQT, and ACT are trademarks of their respective owners and are
used here only to describe the subject matter of practice content.
...
You may create study sets, post messages in study group chat, and submit bug
reports ("User Content"). You keep ownership of your User Content.

You grant us a non-exclusive, worldwide, royalty-free licence to store, display,
and process your User Content solely to operate and improve the service.

You are responsible for what you post. Do not post content that:

- infringes anyone's copyright or other rights
- is unlawful, harassing, hateful, threatening, or sexually explicit
- contains another person's private information
- is spam, advertising, or malware
- facilitates academic dishonesty, such as sharing live exam questions

We may remove User Content and terminate accounts for violations. We are not
obligated to monitor User Content, and we are not responsible for content posted
by other users.

## 5. Study groups and chat

Study group chat is a shared space with other users. Anything you post is
visible to every member of that group. Do not share personal information you
would not want a classmate to have. Group owners and we may remove messages.

## 6. Acceptable use

Do not:

- copy, scrape, resell, or redistribute our questions, explanations, or content
- reverse engineer, decompile, or attempt to extract our source code except to
  the extent that restriction is unenforceable by law
- access the service by automated means beyond ordinary browser use
...
uninterrupted, timely, secure, or error-free, or that content is accurate or
complete.

Some jurisdictions do not allow exclusion of implied warranties, so parts of
...
We are **not liable for indirect, incidental, special, consequential, exemplary,
or punitive damages**, or for lost profits, lost data, lost opportunities, or
**any academic, admissions, or employment outcome**, even if advised of the
possibility.

**Our total aggregate liability** for all claims relating to the service is
limited to the **greater of (a) the amount you paid us in the 12 months before
the event giving rise to the claim, or (b) fifty US dollars ($50).**

These limits apply regardless of the legal theory and even if a limited remedy
fails of its essential purpose. Some jurisdictions do not allow these
...
Exceptions: either party may bring a claim in **small claims court**, and either
...
- **Assignment:** you may not assign these Terms; we may assign them in a merger
